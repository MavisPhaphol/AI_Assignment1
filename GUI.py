...
assignmentInput = Text(window, height = 10, width = 50) #text box for users to put assignment infomation
assignmentInput.pack()
dueDateLabel = Label(window, text="Due Date:", fg="white", background="#343940")
dueDateLabel.pack()
dueDateInput = Text(window, height = 10, width = 20)
dueDateInput.pack()
difficultyLabel = Label(window, text="Difficulty:", fg="white", background="#343940")
difficultyLabel.pack()
difficultyInput = Text(window, height = 10, width = 20)
